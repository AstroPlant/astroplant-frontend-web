...
import { AjaxConfig, AjaxRequest, AjaxResponse, ajax } from "rxjs/ajax";
...
export class BaseAPI {
  ...
  private createRequestArgs = (requestOpts: RequestOpts): RequestArgs => {
    ...
    if (
      ...
      Object.keys(requestOpts.query).length !== 0
    ) {
...
export interface RequestArgs extends AjaxConfig {}
export interface ResponseArgs extends AjaxResponse<unknown> {}
